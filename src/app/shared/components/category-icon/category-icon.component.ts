  ...
  template: `
    ...
    >
      @switch (name()) {
        ...
        @case ('shower') {
          <path d="m4 4 2.5 2.5" /><path d="M13.8 3.8 15 5" /><path d="M8 8l2 2" />
          <path d="m6 14 1.5 1.5" /><path d="M3 12h.01" /><path d="M10 6h.01" />
          <path d="m21 16-5.1-5.1a2 2 0 0 0-2.8 0L8 16v5h13Z" />
        }
        @case ('heart') {
        ...
        @case ('house-heart') {
          <path d="M8.62 13.8A2.25 2.25 0 1 1 12 10.836a2.25 2.25 0 1 1 3.38 2.966l-2.626 2.877a.996.996 0 0 1-1.507 0z" />
        ...
        @case ('sitemap') {
          <rect width="6" height="6" x="9" y="2" rx="1" /><path d="M12 8v4" />
          <path d="M6 14v2" /><path d="M18 14v2" /><path d="M12 12H6a2 2 0 0 0-2 2" />
          <path d="M12 12h6a2 2 0 0 1 2 2" /><rect width="6" height="6" x="3" y="16" rx="1" />
