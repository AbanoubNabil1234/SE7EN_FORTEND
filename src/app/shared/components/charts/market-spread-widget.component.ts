...
@Component({
  ...
  template: `
    <div class="relative w-full rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
      <!-- Header -->
      <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-slate-100 dark:border-neutral-800">
        <div class="flex items-center gap-2.5">
          <div class="flex size-8 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-950/60 dark:text-emerald-400">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 divide-y md:divide-y-0 md:divide-x md:divide-x-reverse divide-slate-100 dark:divide-neutral-800">
        <!-- Metric 1: Average Savings per unit -->
        <div class="pt-2 md:pt-0 md:px-4 space-y-1">
          ...
          <div class="text-[11px] font-semibold text-emerald-700 dark:text-emerald-300">
        ...
        <div class="pt-2 md:pt-0 md:px-4 space-y-1">
          ...
          <div class="text-[11px] font-medium text-amber-700/80 dark:text-amber-400/80">
